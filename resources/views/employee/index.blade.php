    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <a href="{{route('employee.create')}}" class="btn btn-danger pull-right text-white">Add Employee </a>
                    ...
                    <table class="table text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$val->phone}}</td>
                                <td>
                                    <a href="{{ route('employee.edit', [$val->id])}}" target="blank"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle text-primary"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg></a>
                                    <a href="{{ route('employee.show',[$val->id] )}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="View">
                                    ...
                                    <a href="javascript:void(0)" class="delete_employee" data-id="{{$val->id}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="delete"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle text-danger"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg></a>
